...
class Solution {
    public List<Node> printAllDups(Node root) {
        ...
        inOrder(root,ans,set);
        return ans;
    }
    public String inOrder(Node root,List<Node> ans,HashMap<String,Integer> set){
        if(root==null){
            return "";
        }
        String s=root.data+" "+inOrder(root.left,ans,set)+" "+inOrder(root.right,ans,set);
